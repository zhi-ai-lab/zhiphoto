...
The marketplace entry is pinned to the current release. Restart or reload Codex skill discovery after installation when required by the host application.
